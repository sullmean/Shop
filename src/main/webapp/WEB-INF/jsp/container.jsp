				...
				<div class="product-image-wrapper">
					<div class="single-products">
						<div class="productinfo text-center">
							<a href="${pageContext.request.contextPath}/detail?productId=${item.productId}"><img src="${pageContext.request.contextPath}/resources/images?url=${item.listImage[0].url }" alt="" /></a>
